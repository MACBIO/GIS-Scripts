...
inFile = sys.argv[1]
gdal_translateFile = r"C:\Program Files\QGIS Essen\bin\gdal_translate.exe"
gdal_warpFile = r"C:\Program Files\QGIS Essen\bin\gdalwarp.exe"
...
outFile = inFile.split(os.extsep)[0] + "_180.tif"
if not os.path.exists(outFile):
    ...
    args = []
    args.append('"'+gdal_translateFile+'"')
    args.append('-projwin 180 90 360 -90')
    args.append('-a_ullr -180 90 0 -90')
    args.append('"'+inFile+'"')
    args.append('"'+part2+'"')
    command = " ".join(args)
    print command
